...
export default async function FileDetailPage({ params, searchParams }: { params: { id: string }; searchParams?: { preview?: string } }) {
  ...
  const showInlinePreview = previewRequested && Boolean(previewUrl) && (file.file_kind === "pdf" || file.file_kind === "image") && !alreadyPurchased;
