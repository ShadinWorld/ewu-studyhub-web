...
export default async function PaymentSettingsPage() {
  ...
  return <div className="container max-w-3xl py-10 space-y-6">
    ...
    <Card><CardHeader><CardTitle>Request payout</CardTitle><CardDescription>Available balance: {formatBDT(profile.wallet_balance_cents)}</CardDescription></CardHeader><CardContent><form action={requestPayout} className="flex gap-3"><div className="flex-1 space-y-2"><Label htmlFor="amount_bdt">Amount (BDT)</Label><Input id="amount_bdt" name="amount_bdt" type="number" min="1" step="0.01" max={profile.wallet_balance_cents / 100} required /></div><Button type="submit" className="mt-8">Request payout</Button></form></CardContent></Card>
