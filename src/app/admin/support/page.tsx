...
export default async function AdminSupportPage() {
  ...
  const { data: tickets } = await supabase
    ...
    .select("id, category, subject, message, page_path, status, admin_reply, created_at, updated_at, user_id, profiles:user_id (full_name, username, role, university_email, phone_number)")
