...
export default async function AdminSettingsPage() {
  ...
  const [{ data: settings }, { data: logs }, { data: quickActions }, { data: quickAttention }, { data: responseSettings }] = await Promise.all([
    ...
    (supabase as any).from("homepage_quick_attention").select("id,title,icon,href,display_order,is_enabled").eq("audience","admin").order("display_order"),
