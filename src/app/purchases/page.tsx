...
import { Footer } from "@/components/layout/footer";import { InfoButton } from "@/components/ux/info-button";
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="rounded-2xl border bg-gradient-to-br from-primary/10 via-background to-background p-5 shadow-sm sm:p-7">
        ...
        <div className="flex items-center gap-2"><h1 className="mt-1 text-2xl font-bold tracking-tight sm:text-3xl">My Purchases</h1><InfoButton slug="download_resource" title="Download ও Purchases" /></div>
